...
def links_section():
    ...
    github_link=f'<a href="{info.my_github_url}"><img src="{info.github_image_url}" alt="Github" width="65"></a>'
...
def skills_section(programming_data, spoken_data):
    ...
    for skills, percentage in programming_data.items():
        st.write(f'{skills}{info.programming_icons.get(skills,"")}')
